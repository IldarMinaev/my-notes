...
```
Add a record for that dns name in hosts file to redirect it to 127.0.0.1 or install and configure local DNS to redirect all *.demo.rancher-desktop.qubership.org requests to localhost.
\
&nbsp;
\
&nbsp;
